...
const MenuDetail = ({menuData, clickedMenu}) => {
    ...
    const [doubleChecked, setDoubleChecked] = useState(false); // 곱빼기 체크여부
      ...
      <div className="menu-info">
        ...
        <div className="menu-info-detail">
            ...
            <p>{menuData[clickedMenu].desc}</p>
            {
              ...
              (
                <div className="option">
                  <input type="checkbox" name="option_chk" 
                  onClick={() => {
            ...
            <div className="total">
                ...
                <span>최종가격 : {
                  doubleChecked
                   ? Number(totalPrice) + Number(menuData[clickedMenu].option.doublePrice)
                   : totalPrice
